...
public class SMPrivateKey extends BCECPrivateKey {
    private transient DERBitString sm2PublicKey;
    private boolean withCompression;

    public SMPrivateKey(BCECPrivateKey privateKey, BCECPublicKey publicKey) {
        super(privateKey.getAlgorithm(), privateKey);
        this.sm2PublicKey = getSM2PublicKeyDetails(new SMPublicKey(publicKey.getAlgorithm(), publicKey));
    ...
    public byte[] getEncoded() {
        ...
        ASN1Encodable params = SMPublicKey.ID_SM2_PUBKEY_PARAM;
    ...
    private DERBitString getSM2PublicKeyDetails(SMPublicKey pub) {
        try {
